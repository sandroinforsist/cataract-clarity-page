      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <Card className="p-8 lg:p-12 bg-white shadow-xl">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-center">
              <img src="/lovable-uploads/9e8bf759-904c-42f0-a1b2-6693e975fcb6.png" alt="Dr. Carlos Mendonça - Cirurgião Oftalmologista" className="w-64 h-64 object-cover rounded-full mx-auto shadow-2xl" />
